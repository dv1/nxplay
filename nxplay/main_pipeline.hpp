 ...
 *
 * Threads generated by the main pipeline are sorted into three groups:
 *
 ...
 * same priorities, but mainloop threads should not have higher priority
 * than the current stream ones, and those should not have higher proritiy
 * than the audio sink ones.
 *
 ...
 * the minimum allowed priority as the base. Example:
 *
 * @code{.cpp}
