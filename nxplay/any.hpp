#ifndef NXPLAY_ANY_HPP
#define NXPLAY_ANY_HPP

/*
 * Original code from http://www.codeproject.com/Articles/11250/High-Performance-Dynamic-Typing-in-C-using-a-Repla
 * Adapted to fit in the nxplay namespace
 */
